...
function Header() {
  ...
  return <header className="site-header"><div className="nav-wrap">
    ...
    <nav className={open ? 'nav-links is-open' : 'nav-links'} aria-label="Primary navigation">
      <a href="/#method">Method</a><a href="/playbook">Playbook</a><a href="/#case-study">Case study</a><a href="/#insights">Field notes</a><a href="/#about">About</a>
